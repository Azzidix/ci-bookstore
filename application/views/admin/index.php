                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-bar-chart-o"></i> Data <span
            ...
            <div class="right_col" role="main">
                ...
                <div class="row tile_count">
                    <div class="col-md-6 col-sm-6 col-xs-12 tile_stats_count">
                        ...
                        <div class="count"><?php if ($totalSell != NULL) echo $totalSell;
                                else echo 0; ?></div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 tile_stats_count">
                        ...
                        <div class="count"><?php if ($totalProfit != NULL) echo $totalProfit;
                                else echo 0; ?></div>
                        <span class="count_bottom"><i class="grenn"><i class="fa fa-sort-asc"></i>0% </i> This Month
                        </span>
                    </div>
